...
--DROP TRIGGER UpdateInsteadOfDelete

--CREATE TRIGGER tr_Roles ON Roles
--INSTEAD OF DELETE
--AS
--BEGIN
--	DECLARE @Id int
--	SELECT @Id = Id FROM deleted
--	DELETE Users WHERE RoleId = @Id
...
--	DECLARE @Id int
--	SELECT @Id = Id FROM deleted
--	DELETE Musics WHERE CategoryId = @Id
--	DELETE Categories WHERE Id = @Id
--END

--CREATE TRIGGER tr_Musics ON Musics
--INSTEAD OF DELETE
--AS
--BEGIN
--	DECLARE @Id int
...
--CREATE TRIGGER tr_Artists ON Artists
--INSTEAD OF DELETE
--AS
--BEGIN
--	DECLARE @Id int
--	SELECT @Id = Id FROM deleted
--	DELETE FullMusics WHERE ArtistId = @Id
...
--	DECLARE @Id int
--	SELECT @Id = Id FROM deleted
--	DELETE Playlists WHERE UserId = @Id
--	DELETE Users WHERE Id = @Id
--END

--CREATE TRIGGER tr_Playlists ON Playlists
--INSTEAD OF DELETE
--AS
--BEGIN
--	DECLARE @Id int
--	SELECT @Id = Id FROM deleted
--	DELETE PlaylistMusics WHERE PlaylistId = @Id
--	DELETE Playlists WHERE Id = @Id
--END